...
COPY pkgs /tmp/pkgs
RUN rpm-ostree install $(cat /tmp/pkgs/base | grep "^[^#;]")
RUN rpm-ostree install $(cat /tmp/pkgs/virt | grep "^[^#;]")
RUN rpm-ostree install $(cat /tmp/pkgs/docker | grep "^[^#;]")
RUN rpm-ostree install $(cat /tmp/pkgs/nvidia | grep "^[^#;]")
